...
classifiers = {
    "KNN": (KNeighborsClassifier(), {"model__n_neighbors": [3, 5, 7], "model__weights": ["uniform", "distance"], "model__metric": ["euclidean", "manhattan"]}),
    ...
    "Random Forest": (RandomForestClassifier(), {"model__n_estimators": [100, 200], "model__criterion": ["entropy", "gini"]}),
    "MLP": (MLPClassifier(), {"model__hidden_layer_sizes": [(20,), (50,)], "model__activation": ["relu","tanh"], "model__learning_rate_init": [0.1, 1]}),
    "Gradient Boosting": (GradientBoostingClassifier(), {"model__n_estimators": [100, 200], "model__learning_rate": [0.05, 0.1]})
}
